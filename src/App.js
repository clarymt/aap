...
import { consoleAdd } from './actions';
// import { decrement } from './actions';
function App(props) {
  const dispatch = useDispatch();
  //RENDERS PRODUCTLIST FROM STORE
  //USES ONCLICK ACTION DERIVED FROM CNOSOLEREDUCER IDEALLY
  return (
    <ul className="App list-inline">
      <li className="media container">
        <div className="row-12">
        {props.testStore.map(arrayItem => (
          <div key={arrayItem.id}>
            ...
            <div className="media-body list-inline-item">
              ...
              <button onClick={() => dispatch(consoleAdd())} className="btn-warning">Add to Cart</button>
